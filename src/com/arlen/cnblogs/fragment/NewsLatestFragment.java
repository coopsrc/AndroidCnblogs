...
public class NewsLatestFragment extends Fragment implements
		OnItemLongClickListener, OnItemClickListener, OnRefreshListener,
		OnScrollListener {
	private static final String TAG = NewsLatestFragment.class.getSimpleName();
	...
	private void initComponent() {
		swipeRefreshLayout = (SwipeRefreshLayout) this.getActivity()
				.findViewById(R.id.swipeRefreshLayoutLatestNews);
	...
	private void initPath(int pageIndex) {
		...
		path = AppConfig.RECENT_NEWS_PAGED;
