...
public class BlogReadingFragment extends Fragment implements
		...
		OnScrollListener {
	private static final String TAG = BlogReadingFragment.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_blog_reading,
				container, false);
		return rootView;
	}
	...
	private void initComponent() {
		swipeRefreshLayout = (SwipeRefreshLayout) this.getActivity()
				.findViewById(R.id.swipeRefreshLayoutReadingBlog);
