...
public class NewsHotFragment extends Fragment implements
		...
		OnScrollListener {
	private static final String TAG = NewsHotFragment.class.getSimpleName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_news_hot, container,
				false);
		return rootView;
	}
	...
	private void initComponent() {
		swipeRefreshLayout = (SwipeRefreshLayout) this.getActivity()
				.findViewById(R.id.swipeRefreshLayoutHotNews);
